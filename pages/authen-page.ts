...
export class Authen extends PageBase {
    ...
    async loginSuccess() {
        ...
        await allure.logStep('Click on Signup / Login button');
        ...
        await allure.logStep('Enter correct email: '+variableAuthen.email);
    ...
    async loginFail() {
        ...
        await allure.logStep('Enter correct email: '+variableAuthen.email+'1');
        ...
        await allure.logStep('Enter correct password: '+variableAuthen.password+'1');
        await this.page.getByRole('button', { name: elementLocatorAuthen.btnLogin }).click();
        this.logger.info('Click login button');
        await allure.logStep('Click login button');
        await this.page.waitForLoadState("domcontentloaded");
    ...
    async logout() {
        ...
        await allure.logStep('Click logout button');
        expect(await this.page.getByText(elementLocatorAuthen.loginTitle)).toBeVisible();
